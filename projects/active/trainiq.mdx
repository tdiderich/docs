...
**TrainIQ** is an AI-powered iOS app that helps users generate customized workouts based on their goals, equipment, and training style.  
It was built entirely from scratch—with no prior iOS development experience—combining **AI, mobile UX design, and backend automation** to create a seamless fitness experience.
